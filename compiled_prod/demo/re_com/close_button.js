...
return (function() { 
var re_com$close_button$close_button_$_close_button_render__delegate = function (p__6495){
var map__6496 = p__6495;
var map__6496__$1 = (((((!((map__6496 == null))))?(((((map__6496.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6496.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6496):map__6496);
var args = map__6496__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6496__$1,cljs.core.cst$kw$disabled_QMARK_);
var tooltip = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6496__$1,cljs.core.cst$kw$tooltip);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6496__$1,cljs.core.cst$kw$attr);
var left_offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6496__$1,cljs.core.cst$kw$left_DASH_offset);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__6496__$1,cljs.core.cst$kw$color,"#ccc");
var font_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__6496__$1,cljs.core.cst$kw$font_DASH_size,(16));
var div_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__6496__$1,cljs.core.cst$kw$div_DASH_size,(16));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6496__$1,cljs.core.cst$kw$on_DASH_click);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6496__$1,cljs.core.cst$kw$style);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6496__$1,cljs.core.cst$kw$class);
var top_offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6496__$1,cljs.core.cst$kw$top_DASH_offset);
var hover_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__6496__$1,cljs.core.cst$kw$hover_DASH_color,"#999");
if(cljs.core.truth_((((!(goog.DEBUG)))?true:re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic(re_com.validate.extract_arg_data(re_com.close_button.close_button_args_desc),args,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["close-button"], 0))))){
} else {
throw (new Error("Assert failed: (validate-args-macro close-button-args-desc args \"close-button\")"));
}

var disabled_QMARK___$1 = re_com.util.deref_or_value(disabled_QMARK_);
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,cljs.core.cst$kw$class,"rc-close-button",cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$display,"inline-block",cljs.core.cst$kw$position,"relative",cljs.core.cst$kw$width,re_com.util.px(div_size),cljs.core.cst$kw$height,re_com.util.px(div_size)], null),cljs.core.cst$kw$child,new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,cljs.core.cst$kw$class,class$,cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$position,"absolute",cljs.core.cst$kw$cursor,(cljs.core.truth_(disabled_QMARK___$1)?null:"pointer"),cljs.core.cst$kw$font_DASH_size,re_com.util.px(font_size),cljs.core.cst$kw$color,(cljs.core.truth_(cljs.core.deref(over_QMARK_))?hover_color:color),cljs.core.cst$kw$top,re_com.util.px.cljs$core$IFn$_invoke$arity$variadic((((font_size - div_size) / (2)) - top_offset),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$negative], 0)),cljs.core.cst$kw$left,re_com.util.px.cljs$core$IFn$_invoke$arity$variadic((((font_size - div_size) / (2)) - left_offset),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$negative], 0))], null),style], 0)),cljs.core.cst$kw$attr,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$title,tooltip,cljs.core.cst$kw$on_DASH_click,((function (disabled_QMARK___$1,map__6496,map__6496__$1,args,disabled_QMARK_,tooltip,attr,left_offset,color,font_size,div_size,on_click,style,class$,top_offset,hover_color,over_QMARK_){
...
return null;
});})(disabled_QMARK___$1,map__6496,map__6496__$1,args,disabled_QMARK_,tooltip,attr,left_offset,color,font_size,div_size,on_click,style,class$,top_offset,hover_color,over_QMARK_))
,cljs.core.cst$kw$on_DASH_mouse_DASH_enter,((function (disabled_QMARK___$1,map__6496,map__6496__$1,args,disabled_QMARK_,tooltip,attr,left_offset,color,font_size,div_size,on_click,style,class$,top_offset,hover_color,over_QMARK_){
return (function (event){
cljs.core.reset_BANG_(over_QMARK_,true);

return null;
});})(disabled_QMARK___$1,map__6496,map__6496__$1,args,disabled_QMARK_,tooltip,attr,left_offset,color,font_size,div_size,on_click,style,class$,top_offset,hover_color,over_QMARK_))
,cljs.core.cst$kw$on_DASH_mouse_DASH_leave,((function (disabled_QMARK___$1,map__6496,map__6496__$1,args,disabled_QMARK_,tooltip,attr,left_offset,color,font_size,div_size,on_click,style,class$,top_offset,hover_color,over_QMARK_){
return (function (event){
...
while (G__6498__i < G__6498__a.length) {G__6498__a[G__6498__i] = arguments[G__6498__i + 0]; ++G__6498__i;}
  p__6495 = new cljs.core.IndexedSeq(G__6498__a,0,null);
} 
return re_com$close_button$close_button_$_close_button_render__delegate.call(this,p__6495);};
re_com$close_button$close_button_$_close_button_render.cljs$lang$maxFixedArity = 0;
re_com$close_button$close_button_$_close_button_render.cljs$lang$applyTo = (function (arglist__6499){
var p__6495 = cljs.core.seq(arglist__6499);
return re_com$close_button$close_button_$_close_button_render__delegate(p__6495);
});
