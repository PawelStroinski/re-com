...
var base_style__$1 = (cljs.core.truth_((function (){var and__4036__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__4036__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__4036__auto__)){
...
var G__11286_11287 = re_com.selection_list.check_clicked(selections,item_id,cljs.core.not((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id))),required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__11286_11287) : on_change.call(null,G__11286_11287));
}
...
var G__11288_11289 = re_com.selection_list.radio_clicked(selections,item_id,required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__11288_11289) : on_change.call(null,G__11288_11289));
}
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__11293){
...
var args = map__11294__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$disabled_QMARK_);
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$on_DASH_change);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$height);
var item_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$item_DASH_renderer);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$model);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$attr);
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$label_DASH_fn);
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$required_QMARK_);
var as_exclusions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$as_DASH_exclusions_QMARK_);
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$max_DASH_height);
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$hide_DASH_border_QMARK_);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$width);
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$choices);
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$id_DASH_fn);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$style);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$class);
var multi_select_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11294__$1,cljs.core.cst$kw$multi_DASH_select_QMARK_);
...
var items = cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(item_renderer)?((function (selected,map__11294,map__11294__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__11290_SHARP_){
return (item_renderer.cljs$core$IFn$_invoke$arity$8 ? item_renderer.cljs$core$IFn$_invoke$arity$8(p1__11290_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_) : item_renderer.call(null,p1__11290_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_));
});})(selected,map__11294,map__11294__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__11294,map__11294__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__11291_SHARP_){
return re_com.selection_list.as_checked(p1__11291_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11294,map__11294__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
:((function (selected,map__11294,map__11294__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__11292_SHARP_){
return re_com.selection_list.as_radio(p1__11292_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11294,map__11294__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
)),choices);
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__4648__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__11297){
...
var args = map__11298__$1;
if(cljs.core.truth_((((!(goog.DEBUG)))?true:re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic(re_com.validate.extract_arg_data(re_com.selection_list.selection_list_args_desc),args,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["selection-list"], 0))))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__11298,map__11298__$1,args){
return (function() { 
var G__11306__delegate = function (p__11300){
...
while (G__11307__i < G__11307__a.length) {G__11307__a[G__11307__i] = arguments[G__11307__i + 0]; ++G__11307__i;}
  p__11300 = new cljs.core.IndexedSeq(G__11307__a,0,null);
} 
return G__11306__delegate.call(this,p__11300);};
G__11306.cljs$lang$maxFixedArity = 0;
G__11306.cljs$lang$applyTo = (function (arglist__11308){
var p__11300 = cljs.core.seq(arglist__11308);
return G__11306__delegate(p__11300);
});
G__11306.cljs$core$IFn$_invoke$arity$variadic = G__11306__delegate;
return G__11306;
})()
;
;})(map__11298,map__11298__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

/** @this {Function} */
re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq11296){
var self__4629__auto__ = this;
return self__4629__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq11296));
});
