...
if((i < len)){
var k = (ks[i]);
var G__5860 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__5861 = (i + (1));
m = G__5860;
i = G__5861;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__5862 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__5862) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__5862));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__5864 = c;
var G__5864__$1 = (((G__5864 == null))?null:G__5864.prototype);
if((G__5864__$1 == null)){
return null;
} else {
return (G__5864__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__5866 = c;
var G__5866__$1 = (((G__5866 == null))?null:G__5866.prototype);
if((G__5866__$1 == null)){
return null;
} else {
return (G__5866__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__5870__delegate = function (args){
var G__5868 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__5868) : reagent.impl.component.as_element.call(null,G__5868));
};
...
while (G__5871__i < G__5871__a.length) {G__5871__a[G__5871__i] = arguments[G__5871__i + 0]; ++G__5871__i;}
  args = new cljs.core.IndexedSeq(G__5871__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__5874 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__5875 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__5875;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__5874;
}});
...
return ((function (G__5876,G__5876__$1){
...
var c = this;
var G__5881_5883 = (c["cljsRatom"]);
if((G__5881_5883 == null)){
} else {
reagent.ratom.dispose_BANG_(G__5881_5883);
}
...
var renders_5885 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_5886 = cljs.core.first(cljs.core.vals(renders_5885));
if((cljs.core.count(renders_5885) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_5885))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_5886)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_5886], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__5884 = name;
switch (G__5884) {
case "":
...
var G__5889 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__5889) : reagent.impl.component.global$module$create_react_class.call(null,G__5889));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__5890 = fiber;
var G__5890__$1 = (((G__5890 == null))?null:(G__5890["type"]));
if((G__5890__$1 == null)){
return null;
} else {
return (G__5890__$1["displayName"]);
}
})();
var parent = (function (){var G__5891 = fiber;
if((G__5891 == null)){
return null;
} else {
return (G__5891["return"]);
}
})();
var path = (function (){var G__5892 = parent;
var G__5892__$1 = (((G__5892 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__5892) : reagent.impl.component.fiber_component_path.call(null,G__5892)));
if((G__5892__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5892__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4047__auto__ = (function (){var G__5894 = c;
if((G__5894 == null)){
return null;
} else {
return (G__5894["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__5895._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4047__auto__ = (function (){var G__5897 = c;
if((G__5897 == null)){
return null;
} else {
return (G__5897["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = (function (){var G__5899 = c;
if((G__5899 == null)){
return null;
} else {
return G__5899._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4047__auto__ = (function (){var G__5901 = instance;
if((G__5901 == null)){
return null;
} else {
return (G__5901["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var G__5902 = instance;
if((G__5902 == null)){
return null;
} else {
return G__5902._currentElement;
}
}
})();
var name = (function (){var G__5903 = elem;
var G__5903__$1 = (((G__5903 == null))?null:(G__5903["type"]));
if((G__5903__$1 == null)){
return null;
} else {
return (G__5903__$1["displayName"]);
}
})();
var owner = (function (){var or__4047__auto__ = (function (){var G__5905 = elem;
if((G__5905 == null)){
return null;
} else {
return (G__5905["_owner"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__5906._owner;
}
}
})();
var path = (function (){var G__5907 = owner;
var G__5907__$1 = (((G__5907 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__5907) : reagent.impl.component.component_path.call(null,G__5907)));
if((G__5907__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5907__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__5908 = c;
var G__5908__$1 = (((G__5908 == null))?null:G__5908.constructor);
if((G__5908__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__5908__$1);
}
}
})();
