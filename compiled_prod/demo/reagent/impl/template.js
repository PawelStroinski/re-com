...
var G__5926 = o;
(G__5926[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__5927__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__5927 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5928__i = 0, G__5928__a = new Array(arguments.length -  0);
while (G__5928__i < G__5928__a.length) {G__5928__a[G__5928__i] = arguments[G__5928__i + 0]; ++G__5928__i;}
  args = new cljs.core.IndexedSeq(G__5928__a,0,null);
} 
return G__5927__delegate.call(this,args);};
G__5927.cljs$lang$maxFixedArity = 0;
G__5927.cljs$lang$applyTo = (function (arglist__5929){
var args = cljs.core.seq(arglist__5929);
return G__5927__delegate(args);
});
...
var G__5930 = o;
(G__5930[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__5932__i < G__5932__a.length) {G__5932__a[G__5932__i] = arguments[G__5932__i + 0]; ++G__5932__i;}
  args = new cljs.core.IndexedSeq(G__5932__a,0,null);
} 
...
var G__5935 = props;
var G__5935__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5935,cljs.core.cst$kw$id,id):G__5935);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5935__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__5936){
...
var props = map__5937__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5937__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__5937,map__5937__$1,props,class$){
return (function (c){
...
});})(map__5937,map__5937__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__5939){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5940__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__5940,map__5940__$1,on_write){
return (function (){
...
});})(node_value,map__5940,map__5940__$1,on_write))
);
} else {
...
var G__5943 = jsprops;
(G__5943["defaultValue"] = value);

(G__5943["onChange"] = ((function (G__5943,v,value,on_change){
return (function (p1__5942_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__5942_SHARP_);
});})(G__5943,v,value,on_change))
);
...
var vec__5946 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5946,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5946,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5946,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___5950 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___5950 == null)){
} else {
var key_5951 = temp__5724__auto___5950;
(jsprops["key"] = key_5951);
}
...
var temp__5724__auto___5952 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___5952 == null)){
} else {
var key_5953 = temp__5724__auto___5952;
reagent.impl.template.oset(jsprops,"key",key_5953);
}
...
var G__5954 = reagent.impl.template.__GT_NativeWrapper();
(G__5954["name"] = c);
...
var G__5955 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__5955) : reagent.impl.template.as_element.call(null,G__5955));
} else {
...
var len__4641__auto___5960 = arguments.length;
var i__4642__auto___5961 = (0);
while(true){
if((i__4642__auto___5961 < len__4641__auto___5960)){
args__4647__auto__.push((arguments[i__4642__auto___5961]));

var G__5962 = (i__4642__auto___5961 + (1));
i__4642__auto___5961 = G__5962;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq5958){
var G__5959 = cljs.core.first(seq5958);
var seq5958__$1 = cljs.core.next(seq5958);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5959,seq5958__$1);
});
...
break;
default:
var G__5965 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__5965;
continue;
...
var n__4518__auto___5967 = a.length;
var i_5968 = (0);
while(true){
if((i_5968 < n__4518__auto___5967)){
(a[i_5968] = reagent.impl.template.as_element((a[i_5968])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4518__auto___5970 = a.length;
var i_5971 = (0);
while(true){
if((i_5971 < n__4518__auto___5970)){
var val_5972 = (a[i_5971]);
if(((cljs.core.vector_QMARK_(val_5972)) && ((reagent.impl.template.key_from_vec(val_5972) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_5971] = reagent.impl.template.as_element(val_5972));
...
var ctx = ({});
var vec__5974 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5974,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5974,(1),null);
...
var G__5977 = (cljs.core.count(argv) - first_child);
switch (G__5977) {
case (0):
...
var G__5978 = comp;
var G__5979 = jsprops;
var G__5980 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__5978,G__5979,G__5980) : reagent.impl.template.global$module$react.createElement.call(null,G__5978,G__5979,G__5980));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__5977){
